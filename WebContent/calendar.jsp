...
<style type="text/css">
	...
	/* 하이퍼링크 스타일 지정하기 */
	a:link {  /* 한번도 방문하지 않은 하이퍼링크(클릭하지 않은) */
		color: black;
...
// month 13이 넘어왔으면 달력에는 다음해 1월을 표시해야 하고 month 0이 넘어 왔으면 전년도 12월을 표시해야 한다. 	
		if (month >= 13) {
			year++; 
			month = 1;
		} else if(month <= 0) {
...
// 요일별로 글자색을 다르게 출력하기 위해 <td> 태그에 요일에따른 class 속석을 지정한다. (switch 코드 사용)		
